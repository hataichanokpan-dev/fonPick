...
const LABELS = {
  en: {
    ...
    peBand: 'PE vs Band',
    peBandThai: 'PE เทียบแถบ',
    pbFair: 'PB vs Fair PB',
    pbFairThai: 'PB เทียบมูลค่าที่เหมาะสม',
    divYield: 'Dividend Yield',
    divYieldThai: 'อัตราผลตอบแทนปันผล',
    pfcf: 'P/FCF',
    pfcfThai: 'ราคาต่อเงินสดไหลเสรี',
    epsYoY: 'EPS Growth YoY',
    epsYoYThai: 'การเติบโตของกำไรต่อหุ้นรายปี',
